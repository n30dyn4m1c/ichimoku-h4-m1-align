//+------------------------------------------------------------------+
//| Ichimoku H4-M1 Alignment EA (BE30) — EXPERIMENT: H4/H1/M15 only  |
//| Entry: H4→M1 price+chikou all above/below tenkan,kijun,cloud    |
//|        EXCEPT M30, M5, M1 — removed from the alignment filter   |
...
int MAGIC = 20260824;   // fresh number — H4/H1/M15-only experimental build (20260815 is the live VPS)
