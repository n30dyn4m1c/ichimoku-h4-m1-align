//+------------------------------------------------------------------+
//| Ichimoku H4-M1 Alignment EA (BE30) — EXPERIMENT: no M30, no M1  |
//| Entry: H4→M1 price+chikou all above/below tenkan,kijun,cloud    |
//|        EXCEPT M30 and M1 — removed from the alignment filter    |
...
int MAGIC = 20260823;   // fresh number — no-M30/no-M1 experimental build (20260815 is the live VPS)
