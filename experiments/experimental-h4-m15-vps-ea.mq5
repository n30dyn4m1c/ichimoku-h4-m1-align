//+------------------------------------------------------------------+
//| Ichimoku H4-M15 Alignment EA (BE30) — EXPERIMENT: VPS-derived   |
//| Entry: H4→M15 price+chikou all above/below tenkan,kijun,cloud    |
//|        (H4 and M15 ONLY — H1, M30, M5, M1 disregarded)           |
...
#define MAX_SYMS  60
#define TF_COUNT  2
#define IDX_M15   1   // index of M15 in tfs[] — used for exit check

ENUM_TIMEFRAMES tfs[TF_COUNT] = {
   PERIOD_H4, PERIOD_M15
};
...
int MAGIC = 20260825;   // fresh number — H4+M15-only experimental build (20260815 is the live VPS)
