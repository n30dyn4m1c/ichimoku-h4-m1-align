...
//|        THIS FORK runs 20260861 — fresh, so it never adopts the    |
//|        live build's positions on the test account.                |
//| Author: Neo Malesa                                               |
//+------------------------------------------------------------------+
#property strict
...
int MAGIC = 20260861;   // BTCUSD# test fork — fresh, never adopts the live build's positions (live VPS = 20260858, desktop = 20260860)
