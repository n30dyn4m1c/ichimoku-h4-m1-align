//+------------------------------------------------------------------+
//| Ichimoku Bottom-Up Stack EA — KIHON + PO3 GATES + LEVEL VETOES   |
//|                                                                  |
//| A fork of the kihon-suchi + PO3 gate experiment                   |
//| (experimental-bottomup-stack-kihon-po3-ea.mq5, magic 20260865),   |
//| which is itself a fork of the live VPS build (magic 20260858).    |
//| The M1-strict cloud bias, the robustness pack (R2-R6), the daily  |
//| H1 kihon time gate and the PO3 room/target gate are all           |
//| unchanged from that parent. What is new here is TWO LOCATION      |
//| VETOES on top, so an entry now answers five questions in order,   |
//| cheapest first:                                                   |
//|                                                                  |
...
//|                        dealing range?              (new, off by   |
//|                                                     default)      |
//|                                                                  |
//| The parent asked only gates 1-3, and each gate can veto on its    |
//| own. Gates 1, 4 and 5 are market-wide (they do not depend on the  |
//| tier); gates 2 and 3 are per-tier.                                |
//|                                                                  |
//|------------------------------------------------------------------|
...
//| Magic: 20260867 — free (20260866, the M1+M2 fixed-target experiment, |
//|        is the highest in use). Shares positions with nothing, and   |
//|        NOT with the live build or with either parent (20260865 the  |
//|        kihon+PO3 experiment, 20260866 the fixed-target experiment), |
//|        so this can run beside production and beside both parents    |
//|        without any of them managing another's trades.               |
//| Author: Neo Malesa                                               |
//+------------------------------------------------------------------+
#property strict
...
int MAGIC = 20260867;   // free — 20260866 is the highest in use. Shares nothing.
