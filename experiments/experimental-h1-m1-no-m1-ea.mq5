//+------------------------------------------------------------------+
//| Ichimoku H1-M1 Alignment EA (BE30) — EXPERIMENT: no M1          |
//| Entry: H1→M5 price+chikou all above/below tenkan,kijun,cloud    |
...
ENUM_TIMEFRAMES tfs[TF_COUNT] = {
   PERIOD_H1, PERIOD_M30, PERIOD_M15, PERIOD_M5
};
...
int MAGIC = 20260829;   // fresh number — no-M1 experimental build (20260814 is the live H1 VPS)
