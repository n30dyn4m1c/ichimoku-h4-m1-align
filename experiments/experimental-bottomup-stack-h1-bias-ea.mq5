...
//| that build except for the stack's top end and how entries are     |
//| gated: a D1 tier on top of H4, a bias LADDER (D1 -> H4 -> H1) in  |
//| which a flat step hands over to the one below it, and a flat-     |
//| kijun filter that runs on EVERY timeframe of the stack.           |
...
int MAGIC = 20260850;   // fresh — D1..M1 ladder variant (20260848 is the snapshot it forks, 20260846/47 the live VPS builds)
