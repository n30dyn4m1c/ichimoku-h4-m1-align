//+------------------------------------------------------------------+
//| Ichimoku H4-M1 Alignment EA (BE30) — EXPERIMENT: no M30          |
//| Entry: H4→M1 price+chikou all above/below tenkan,kijun,cloud    |
//|        EXCEPT M30 — removed from the alignment filter            |
...
ENUM_TIMEFRAMES tfs[TF_COUNT] = {
   PERIOD_H4, PERIOD_H1, PERIOD_M15, PERIOD_M5, PERIOD_M1
};
...
int MAGIC = 20260822;   // fresh number — no-M30 experimental build (20260815 is the live VPS)
