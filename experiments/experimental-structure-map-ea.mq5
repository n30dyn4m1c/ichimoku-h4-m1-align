...
//| Entry: continuation bounces — price pulls back into an Ichimoku   |
//|        structure (kijun, tenkan, cloud edge) on a higher          |
//|        timeframe and reacts away from it in the direction the     |
//|        structure map already favours. No breakout alignment is    |
//|        required; the map decides the direction, the bounce        |
//|        decides the timing.                                        |
