...
input double InpRiskTier2At     = 7000.0; // Equity where risk drops to regime 2
...
double LevelRiskPct(int lvl)
{
   ...
   int r = (eq >= InpRiskTier5At) ? 5 : (eq >= InpRiskTier4At) ? 4 :
           (eq >= InpRiskTier3At) ? 3 : (eq >= InpRiskTier2At) ? 2 : 1;
   switch(lvl)
   {
      case 0:  return r == 5 ? InpRiskPctM5_T5  : r == 4 ? InpRiskPctM5_T4  : r == 3 ? InpRiskPctM5_T3  : r == 2 ? InpRiskPctM5_T2  : InpRiskPctM5;
      case 1:  return r == 5 ? InpRiskPctM15_T5 : r == 4 ? InpRiskPctM15_T4 : r == 3 ? InpRiskPctM15_T3 : r == 2 ? InpRiskPctM15_T2 : InpRiskPctM15;
      case 2:  return r == 5 ? InpRiskPctM30_T5 : r == 4 ? InpRiskPctM30_T4 : r == 3 ? InpRiskPctM30_T3 : r == 2 ? InpRiskPctM30_T2 : InpRiskPctM30;
      case 3:  return r == 5 ? InpRiskPctH1_T5  : r == 4 ? InpRiskPctH1_T4  : r == 3 ? InpRiskPctH1_T3  : r == 2 ? InpRiskPctH1_T2  : InpRiskPctH1;
      case 4:  return r == 5 ? InpRiskPctH4_T5  : r == 4 ? InpRiskPctH4_T4  : r == 3 ? InpRiskPctH4_T3  : r == 2 ? InpRiskPctH4_T2  : InpRiskPctH4;
   }
   return 0.0;
}
