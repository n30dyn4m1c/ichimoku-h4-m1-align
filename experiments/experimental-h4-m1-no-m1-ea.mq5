//+------------------------------------------------------------------+
//| Ichimoku H4-M1 Alignment EA (BE30) — EXPERIMENT: no M1          |
//| Entry: H4→M5 price+chikou all above/below tenkan,kijun,cloud    |
//|        EXCEPT M1 — removed from the alignment filter            |
...
ENUM_TIMEFRAMES tfs[TF_COUNT] = {
   PERIOD_H4, PERIOD_H1, PERIOD_M30, PERIOD_M15, PERIOD_M5
};
...
int MAGIC = 20260828;   // fresh number — no-M1 experimental build (20260815 is the live VPS)
