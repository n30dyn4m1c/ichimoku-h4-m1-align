//+------------------------------------------------------------------+
//| Ichimoku H4-H1 Alignment EA — swing build (experimental, SILVER)|
...
int MAGIC = 20260818;   // fresh number — distinct from all D1-H4 / H4-M1 / H1-M1 builds
