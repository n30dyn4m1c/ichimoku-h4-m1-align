//+------------------------------------------------------------------+
//| Ichimoku Bottom-Up Stack EA (H1 bias) — VPS build                 |
//| The live VPS build since 2026-08-18. It replaces the former       |
//| top-down alignment VPS build (dual-mode InpTopTF, H4->M1 /        |
//| H1->M1, kijun-start filter, BE30); that file is archived as       |
//| archives/ichimoku-h4-m1-vps-ea-archived20260818.mq5 and is no     |
//| longer deployed.                                                  |
...
//| Magic: 20260850 — carried over from the experiment this build was |
//|        promoted from, so positions it already opened keep being   |
//|        managed. Distinct from the archived top-down VPS magics    |
//|        (20260846/47) and the desktop build (20260852).            |
//| Author: Neo Malesa                                               |
//+------------------------------------------------------------------+
#property strict
...
int MAGIC = 20260850;   // VPS bottom-up H1-bias build (desktop twin runs 20260852)
