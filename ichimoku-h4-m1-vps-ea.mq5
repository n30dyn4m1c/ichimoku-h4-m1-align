...
//|        (9/17/26/33/42/51/65/76/83/97). Nested: H4 is checked     |
//|        first, then H1, then M30, then M15 — each must be clear   |
...
input bool   InpTimeFilterH4   = true;    // Check H4 first (exact match, up to cycle 100)
