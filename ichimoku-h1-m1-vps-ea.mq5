...
bool TimeFilterBlocks(int s, int st)
{
   ...
   if(InpTimeFilterH1)
   {
      ...
      int cF1 = CountSinceFractal(s, 0, st, KIHON_MAX_CYCLE);
      if(InTimeWindow(c1, KIHON_MAX_CYCLE) || InTimeWindow(cF1, KIHON_MAX_CYCLE))
      {
         LogTimeSkip(s, 0, c1, cF1, "H1");
         return true;
      }
   }
   if(InpTimeFilterM30)
   {
      ...
      int cF30 = CountSinceFractal(s, 1, st, KIHON_MAX_CYCLE);
      if(InTimeWindow(c30, KIHON_MAX_CYCLE) || InTimeWindow(cF30, KIHON_MAX_CYCLE))
      {
         LogTimeSkip(s, 1, c30, cF30, "M30");
         return true;
      }
   }
   if(InpTimeFilterM15)
   {
      ...
      int cF15 = CountSinceFractal(s, 2, st, KIHON_MAX_CYCLE);
      if(InTimeWindow(c15, KIHON_MAX_CYCLE) || InTimeWindow(cF15, KIHON_MAX_CYCLE))
      {
         LogTimeSkip(s, 2, c15, cF15, "M15");
         return true;
      }
   }
   if(InpTimeFilterM5)
   {
      ...
      int cF5 = CountSinceFractal(s, IDX_M5, st, KIHON_MAX_CYCLE);
      if(InTimeWindow(c5, KIHON_MAX_CYCLE) || InTimeWindow(cF5, KIHON_MAX_CYCLE))
      {
         LogTimeSkip(s, IDX_M5, c5, cF5, "M5");
         return true;
      }
   }
   return false;
